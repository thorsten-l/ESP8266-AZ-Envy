...
#define MQ2_HANDLER_STATUS_UNDEFINED 0
#define MQ2_HANDLER_STATUS_FINISHED 1
#define MQ2_HANDLER_STATUS_BEGIN 2
#define MQ2_HANDLER_STATUS_READING 3
#define MQ2_HANDLER_STATUS_READ_END 4
#define MQ2_HANDLER_INERVAL 15000
...
class MQ2 {
    ...
    float handlerRs;
    int handlerStatus = MQ2_HANDLER_STATUS_UNDEFINED;
		int handlerIteration;
		time_t handlerTimestamp;
};
